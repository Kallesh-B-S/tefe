...
import { getCarnetSummaryData, getHomePageData, saveAll } from "../reduxToolKit/thunk/homePage";
...
export default function HomePage() {
  ...
  useEffect(() => {
    getCarnetSummaryData(dispatch, setError, setLoading);
  }, []);
  ...
  }, [basicDetailsData, ParamTableData, FeesAndCommissionTableData, LoginTableEditData])
        ...
        <div className=" m-auto flex w-[90%] flex-wrap justify-evenly pb-10">
          {
            pieChartSelector.data.map((x: {
              ...
              <div key={x.Service_Provider_Name + i} className="bg-gray-300 rounded-2xl m-5">
                ...
                <div className="flex justify-center mt-1"><FiEdit onClick={() => { setChatClicked(true), getHomePageData(dispatch, x.SPID) }} className="!cursor-pointer" /></div>
