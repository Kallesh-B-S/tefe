...
const Navbar = ()=>{
  ...
  // console.log(router);
    ...
    return(
        <div className="navbar sticky top-0 h-[100px] md:h-[80px] w-full flex justify-center items-center md:justify-start md:space-x-10 bg-[#FFFFFF] select-none !z-100">
          ...
          <div className="navbarImage w-[60px] h-[60px] md:ml-10 xl:ml-32">
            <Image src={"/img/landingPage/uscib_logo_green_type2-square.jpg"} alt="" className="w-full h-full" width={100} height={100} />
          </div>
